...
/// Custom implementation of [LogPrinter] based on PrettyPrinter, with modifications.
///
/// Output format is as follows:
/// ```
/// [timestamp] [level emoji/label] [logger name]
/// Error info (if present)
/// Stack trace or method history (if present)
/// Log message (may span multiple lines)
/// ```
/// This printer supports custom coloring, emojis, timestamp formatting, and clear separation for error, stack, and message sections.
class CustomPrinter extends LogPrinter {
  static final Map<Level, AnsiColor> defaultLevelColors = {
    Level.trace: AnsiColor.fg(AnsiColor.grey(0.5)),
    Level.debug: const AnsiColor.none(),
    Level.info: const AnsiColor.fg(35),
